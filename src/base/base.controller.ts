...
export class BaseController {
    ...
    protected throwErrorProcess(error: any) {
        ...
        if (error instanceof BaseError) {
            ...
            throwDatabase(this.l.lang('UNKNOWN_ERROR', 'vi'), JSON.stringify(error), ErrorCodes.UNKNOWN);
        }

        throw new DatabaseError(this.l.lang('UNKNOWN_ERROR', 'vi'), { errorContent: error }, ErrorCodes.UNKNOWN);
    }
}
